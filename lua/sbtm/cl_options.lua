...
hook.Add("PopulateToolMenu", "SBTM", function()
    spawnmenu.AddToolMenuOption("Utilities", "Admin", "SBTM_Server", "#sbtm.title", "", "", function(pnl)
    ...
    spawnmenu.AddToolMenuOption("Utilities", "User", "SBTM_Client", "#sbtm.title", "", "", function(pnl)
        pnl:Help("#sbtm.menuhelp")
